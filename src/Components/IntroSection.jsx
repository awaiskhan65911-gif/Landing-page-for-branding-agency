...
export const IntroSection = () => {
    return (
        <section className="relative  before:w-full before:left-0 before:-top-2 before:opacity-20  before:h-[1px] before:absolute before:bg-gradient-to-r before:from-[#4bb6ef] before:via-[#dd933e] before:to-[#d82e5a]">
