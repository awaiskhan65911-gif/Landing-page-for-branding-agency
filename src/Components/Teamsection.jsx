...
export const Team = () => {
    return (
        <section className="relative">
            <div className="absolute bg-[url('/images/Shapes/shape-19.png')] bg-center bg-no-repeat bg-cover left-0 top-0 w-full h-full z-0"></div>
                                ...
                                <div>  
                                    ...
                                    <div className="bg-[#161b2299] px-4 py-2 text-[#fff] hover:text-[#181e25] hover:bg-[#fff6] backdrop-blur-[20px] absolute  left-0 bottom-0 w-full rounded-b-3xl flex items-center justify-between transition-all duration-500">
                                        ...
                                        <div className=''>
                                            ...
                                            <ul className="bg-[url('/images/Shapes/shape-18.png')] bg-cover bg-center bg-no-repeat absolute  p-3 flex flex-col gap-4 bottom-6 right-2 opacity-0  translate-y-2   hover:opacity-100 hover:scale-100 hover:translate-y-0 transition-all duration-500 ease-in-out z-20  cursor-pointer ">
