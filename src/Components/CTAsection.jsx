...
export const CtaSection = (variant,className) =>{
    return(
        <section className="relative">
            ...
            <div className="text-[#fff] flex items-center justify-between bg-bodycolor p-20  w-full rounded-[40px] shadow-xl max-w-[1456px] mx-auto ">
                ...
                <div className="hidden md:block">
                    <img src="/images/Icons/loud-1.png" alt="img" />
                </div>
            </div>
